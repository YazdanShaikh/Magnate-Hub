                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Name" id="name" required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <input type="number" class="form-control mt-2" placeholder="Price" id="price" required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Year Trading" id="trading" required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Earning Type" id="earning_type" required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Stock Level" id="stock_level" required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <textarea id="summary" placeholder="Summary" rows="5" class="form-control mt-2" required></textarea>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <textarea id="location_information" placeholder="Location Information" rows="5" class="form-control mt-2" required></textarea>
                        </div>
                        <div class="col-lg-12 col-md-12">
