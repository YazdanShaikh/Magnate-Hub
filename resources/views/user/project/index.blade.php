            ...
            <form onsubmit="Create(event)">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Year Trading" id="trading"
                                required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Earning Type" id="earning_type"
                                required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <input type="text" class="form-control mt-2" placeholder="Stock Level" id="stock_level"
                                required>
                        </div>
                        <div class="col-lg-12 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-danger mx-2" data-bs-dismiss="modal"><i
                ...
                <div class="col-4">
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-primary waves-effect waves-light m-1" title="New"
                            data-bs-toggle="modal" data-bs-target="#Create_Model"><i aria-hidden="true"
