                            ...
                            <div class="chat-box">
                                ...
                                <div class="chat-left-aside">
                                    <div class="media">
                                        ...
                                        @else
                                            <img class="rounded-circle user-image" src="{{ asset('/uploads/user/profile/' . session()->get("profile")) }}" style="object-fit: cover;">
                                        @endif
                                ...
                                <div class="col chat-right-aside">
                                    ...
                                    <div class="chat">
                                        ...
                                        <div class="media chat-header clearfix">
                                            ...
                                            <img class="rounded-circle" src="/user/assets/profile.png"  id="card" style="width : 50px; height : 50px; object-fit : cover;">
                                        
                                            <div class="media-body">
                                                <div class="about">
                                                    <div class="name" id="project"></div>
                                                    <a href="#" id="Profile_Link"><div class="status digits" id="raising_name"></div></a>
                                                </div>
                                            </div>
                                            ...
                                            <ul id="Chat">
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        <img style="height:500px; object-fit:contain;" src="/user/assets/chat.png">
                                                    </div>
                                                </div>
                                            </ul>
                                        </div>
        ...
        if ($("#project_id").val() != 0) {
            ...
            $.ajax({
                ...
                if (response.error == true) {
                    ...
                    if (response.Chat > $("#message_count").val()) {
