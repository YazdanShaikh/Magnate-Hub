...
{
    public function index(){return view('user.project.index');}
    ...
    public function Get(Request $request){
        if (session()->get("account_id")) {
            $Where = [['project.user_id',session()->get("user_id")]];
            ...
            $project = DB::table('project')->leftjoin('account','account.account_id','=','project.account_id')->select('project.name','project.status','project.code','project.date','project.card','account.name as account')->where($Where)->orderby('project.project_id',$request->orderby)->take($request->take)->get(); return view('user.include.project.index',['project'=>$project]);
        }else{return response()->json(['error' => true]);}
    }
    ...
    public function Edit($code){
        if (session()->get("account_id")) {
            ...
            return view('user.project.edit',['Edit'=>$Edit,'code'=>$code]);
        }else{return response()->json(['error' => true]);}
    }
    ...
    public function Project_Images($code){
        return view("user.project.images",['code'=>$code]);
    }
    ...
    public function Project_Get_Images(Request $request){
        if (session()->get("account_id")) {
            $project = DB::table('project')->select('images')->wherecode($request->code)->get();
            return view('user.include.project.images',['project'=>$project]);
